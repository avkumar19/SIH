...
return array(
	...
	'a_followed_body' => "Your acknowledgement on ^site_title has a new related idea by ^q_handle:\n\n^open^q_title^close\n\nYour acknowledgement was:\n\n^open^a_content^close\n\nClick below to acknowledge the new idea:\n\n^url\n\nThank you,\n\n^site_title",
	'a_followed_subject' => 'Your ^site_title acknowledgement has a related idea',
	...
	'q_answered_body' => "Your idea on ^site_title has been acknowledged by ^a_handle:\n\n^open^a_content^close\n\nYour idea was:\n\n^open^q_title^close\n\nIf you like this acknowledgement, you may select it as the best:\n\n^url\n\nThank you,\n\n^site_title",
	'q_answered_subject' => 'Your ^site_title idea was acknowledged',
