...
return array(
	...
	'allow_close_questions' => 'Allow submitted grievances to be manually closed:',
	'allow_close_own_questions' => 'Allow users to close their own submitted grievances:',
	'allow_login_email_only' => 'Only log in by email address (not username):',
	'allow_multi_answers' => 'Allow multiple acknowledgement per user:',
	'allow_no_category' => 'Allow grievances with no category',
	'allow_no_sub_category' => 'Allow grievances with a category but no sub-category',
	'allow_private_messages' => 'Enable private messaging between users:',
	'allow_self_answer' => 'Allow users to acknowledge their own submitted grievances:',
	'allow_user_walls' => 'Enable wall posts on user profiles:',
	'allow_view_q_bots' => 'Allow search engines to view grievances pages',
	...
	'avatar_q_list_size' => 'Avatar size on submitted grievance lists:',
	'avatar_q_page_a_size' => 'Avatar size on acknowledgement:',
	'avatar_q_page_c_size' => 'Avatar size on comments:',
	'avatar_q_page_q_size' => 'Avatar size on submitted grievances:',
	...
	'caching_q_start' => 'Start caching grievances after:',
	'caching_q_time' => 'Cache grievance pages for:',
	'caching_qlist_time' => 'Cache grievance lists for:',
	...
	'comment_on_as' => 'Allow comments on acknowledgements:',
	'comment_on_qs' => 'Allow comments on submitted grievances:',
	...
	'default_sidebar' => 'Welcome to ShoutOut, where you can submit your latest grievances and receive their redressal from the government.',
	'default_subject' => 'A message from ^',
	'default_suffix' => 'ShoutOut',
	'default_terms' => 'I agree to the ^ Terms & Conditions and Privacy Policy',
	'do_ask_check_qs' => 'Check for similar grievances when submitting:',
	'do_close_on_select' => 'Close submitted grievances with a selected acknowledgements:',
	'do_complete_tags' => 'Show matching tags while typing:',
	'do_count_q_views' => 'Count the number of submitted grievances views:',
	'do_example_tags' => 'Show example tags based on submitted grievances:',
	'editor_for_as' => 'Default editor for acknowledgements:',
	'editor_for_cs' => 'Default editor for comments:',
	'editor_for_qs' => 'Default editor for grievances:',
	...
	'extra_field_display' => 'Show the extra information on submitted grievance pages',
	'extra_field_display_label' => 'Show the extra information on submitted grievance pages with label:',
	'feed_for_activity' => 'Feed for recent activity:',
	'feed_for_hot' => 'Feed for most pitched grievances:',
	'feed_for_qa' => 'Feed for recent grievances and acknowledgements:',
	'feed_for_questions' => 'Feed for recent submitted grievances:',
	'feed_for_search' => 'Feeds for search results:',
	'feed_for_tag_qs' => 'Feed for each tag\'s submitted grievances:',
	'feed_for_unanswered' => 'Feed for unheard grievances:',
	...
	'follow_on_as' => 'Allow submitted grievances to be related to acknowledgements:',
	'from_email' => 'Sender address for messages from site:',
	'hot_weight_a_age' => 'Grievance has a new acknowledgement:',
	'hot_weight_answers' => 'Grievances has many acknowledgements:',
	'hot_weight_q_age' => 'Grievance is new:',
	'hot_weight_views' => 'Grievance has many views:',
	'hot_weight_votes' => 'Grievance has many up votes:',
	...
	'match_4' => 'Wider',
	'match_5' => 'Widest',
	'match_ask_check_qs' => 'Similar grievances matching:',
	'match_example_tags' => 'Example tags matching:',
	'match_related_qs' => 'Related grievances matching:',
	'max_len_q_title' => 'Maximum length of grievance title:',
	'max_num_q_tags' => 'Maximum number of tags:',
	'max_rate_ip_as' => 'Rate limit for adding acknowledgement:',
	...
	'max_rate_ip_qs' => 'Rate limit for submitting grievances:',
	...
	'max_rate_user_as' => 'Maximum acknowledgements per user per hour:',
	...
	'max_rate_user_qs' => 'Maximum grievance submissions per user per hour:',
	'max_rate_user_uploads' => 'Maximum uploads per user per hour:',
	'max_rate_user_votes' => 'Maximum votes per user per hour:',
	'min_len_a_content' => 'Minimum length of acknowledgements:',
	'min_len_c_content' => 'Minimum length of comment:',
	'min_len_q_content' => 'Minimum length of grievance body:',
	'min_len_q_title' => 'Minimum length of grievance title:',
	...
	'notify_admin_q_post' => 'Email this address when a grievance is posted',
	'notify_users_default' => 'Check email notification box by default:',
	'option_default' => 'Default',
	'page_size_activity' => 'Length of All Activity page:',
	'page_size_ask_check_qs' => 'Maximum similar grievances to show:',
	'page_size_ask_tags' => 'Maximum tag hints to show:',
	'page_size_home' => 'Length of ShoutOut page:',
	'page_size_hot_qs' => 'Length of most pitched! page:',
	'page_size_pms' => 'Private messages per page:',
	'page_size_q_as' => 'Maximum acknowledgements per page:',
	'page_size_qs' => 'Length of grievances page:',
	'page_size_related_qs' => 'Maximum related grievances:',
	'page_size_search' => 'Search results per page:',
	'page_size_tag_qs' => 'Grievances on each tag page:',
	'page_size_tags' => 'Length of Tags page:',
	'page_size_una_qs' => 'Length of unheard grievances page:',
	...
	'points_a_selected' => 'Having your acknowledgement selected as the best:',
	'points_a_voted_max_gain' => 'Limit from up votes on each acknowledgement:',
	'points_a_voted_max_loss' => 'Limit from down votes on each acknowledgement:',
	...
	'points_per_a_voted_down' => 'Per down vote on your acknowledgement:',
	'points_per_a_voted_up' => 'Per up vote on your acknowledgement:',
	'points_per_c_voted_down' => 'Per down vote on your comment:',
	'points_per_c_voted_up' => 'Per up vote on your comment:',
	'points_per_q_voted_down' => 'Per down vote on your grievance:',
	'points_per_q_voted_up' => 'Per up vote on your grievance:',
	'points_post_a' => 'Posting an acknowledgement:',
	'points_post_q' => 'submitting an grievance:',
	'points_q_voted_max_gain' => 'Limit from up votes on each grievance:',
	'points_q_voted_max_loss' => 'Limit from down votes on each grievance:',
	'points_select_a' => 'Selecting an acknowledgement for your grievance:',
	'points_vote_down_a' => 'Voting down an acknowledgement:',
	'points_vote_down_q' => 'Voting down an grievance:',
	'points_vote_up_a' => 'Voting up an grievance:',
	'points_vote_up_q' => 'Voting up a grievance:',
	'q_urls_remove_accents' => 'Remove accents from grievance URLs:',
	'q_urls_title_length' => 'grievances title length in URLs:',
	'recalc_hotness_q_view' => 'Recalculate most pitchedness on every grievance page view:',
	'register_notify_admin' => 'Email me when a new user registers:',
	'search_module' => 'Use search module:',
	'show_a_form_immediate' => 'Show acknowledgement form immediately:',
	'show_always' => 'Always',
	'show_c_reply_buttons' => 'Show reply button on comments:',
	'show_compact_numbers' => 'Show compact numbers (e.g. 1.3k):',
	'show_custom_answer' => 'Custom message on acknowledgement form - HTML allowed:',
	...
	'show_if_no_as' => 'If no acknowledgement',
	...
	'show_selected_first' => 'Move selected acknowledgement to the top:',
	...
	'show_view_count_q_page' => 'Show view count on grievance pages:',
	'show_view_counts' => 'Show view count in grievance lists:',
	...
	'voting_on_as' => 'Allow voting on acknowledgements:',
	'voting_on_cs' => 'Allow voting on comments:',
	'voting_on_q_page_only' => 'Allow voting on grievance page only:',
	'voting_on_qs' => 'Allow voting on grievances:',
);
