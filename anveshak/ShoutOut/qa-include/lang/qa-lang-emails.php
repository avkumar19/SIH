...
return array(
	'a_commented_body' => "Your acknowledgement on ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour acknowledgement was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
	'a_commented_subject' => 'Your ^site_title acknowledgement has a new comment',

	'a_followed_body' => "Your acknowledgement on ^site_title has a new related grievance by ^q_handle:\n\n^open^q_title^close\n\nYour acknowledgement was:\n\n^open^a_content^close\n\nClick below to acknowledge the new grievance:\n\n^url\n\nThank you,\n\n^site_title",
	'a_followed_subject' => 'Your ^site_title acknowledgement has a related grievance',

	'a_selected_body' => "Congratulations! Your acknowledgement on ^site_title has been selected as the best by ^s_handle:\n\n^open^a_content^close\n\nThe grievance was:\n\n^open^q_title^close\n\nClick below to see your acknowledgement:\n\n^url\n\nThank you,\n\n^site_title",
	'a_selected_subject' => 'Your ^site_title acknowledgement has been selected!',
	...
	'q_answered_body' => "Your grievance on ^site_title has been acknowledged by ^a_handle:\n\n^open^a_content^close\n\nYour grievance was:\n\n^open^q_title^close\n\nIf you like this acknowledgement, you may select it as the best:\n\n^url\n\nThank you,\n\n^site_title",
	'q_answered_subject' => 'Your ^site_title grievance was acknowledged',

	'q_commented_body' => "Your grievance on ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour grievance was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
	'q_commented_subject' => 'Your ^site_title grievance has a new comment',

	'q_posted_body' => "A new grievance has been asked by ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nClick below to see the grievance:\n\n^url\n\nThank you,\n\n^site_title",
	'q_posted_subject' => '^site_title has a new grievance',
